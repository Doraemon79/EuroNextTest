...
using static WeatherForecastAPI.Validators.RequestValidator;
...
namespace WeatherForecastAPI.Controllers
{
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<WeatherForecastDisplay>>> GetAll()
        {
            ...
            var forecasts = await _euroNextService.GetWeekAsync(DateOnly.FromDateTime(DateTime.Now));
            return Ok(forecasts);
        }
        ...
        public async Task<ActionResult<WeatherForecastDisplay>> GetDetailsByDate(DateOnly date)
        {
            ...
            {
                var forecast = await _euroNextService.GetByDateAsync(date);
                return Ok(forecast);
            }
            else
            {
